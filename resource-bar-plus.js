...
(function () {
  ...
  var img_view = "data:image/png;base64,"
  ...
  var img_bmove = "data:image/png;base64,"
  ...
  function resourceCalculator ( tObj, timeToGo, incomingRes, tType ) { // tType 0-market 1-RP
    ...
    if( tType == 0 ) {
      if( RB.Setup[11] > 0 ) textIncome += '<img class="npc" src="https://cdn.legends.travian.com/gpack/144.8/img_ltr/components/iconValueBox/allResources.png"/> <span style="margin-'+docDir[1]+': auto;">&#931;('+incomeToGoSumm+')</span>';
      ...
      if( RB.Setup[11] > 0 ) textIncome += ' (<img class="npc" style="margin:3px;background:none;" src="https://cdn.legends.travian.com/gpack/144.8/img_ltr/components/iconValueBox/allResources.png">'+incomeToGoSumm+')';
      var newFText = retFL ? $em('A',[trImg("clock"),' ',formatTime(absTime(timeToGo,serverTime), 1)],[['href','#'+allIDs[31]]]):
  ...
  function progressbar_init() {
    ...
    for (var j = 0; j < 4; j++) {
      ...
      if( RB.Setup[22] > 0 ) {
        if( j == mm[0] ) sumAttr.push(['style','color:unset;']);
        if( j == mm[1] ) sumAttr.push(['style','color:unset;']);
      }
  ...
  function viewMessageIW() {
    ...
    for( var i = 0; i < allRows.snapshotLength; i++ ) {
      ...
      $at(newImg,[['style','margin-top:1px;margin-right:6px;cursor:pointer;position:relative;float:'+docDir[0]+';'+(/report/.test(crtPath)?'':docDir[0]+':-6px;')]]);
  ...
  function viewMessageIWK ( piBl ) {
    ...
    for( var i = 0; i < allRows.snapshotLength; i++ ) {
      ...
      if( /alliance/.test(crtPath) )
        $at(newImg,[['style','margin-top:1px;cursor:pointer;position:relative;float:'+docDir[0]+';'+docDir[0]+':-5px;']]);
      td.insertBefore(newImg, td.firstChild);
  ...
  function normalizeProduction () {
    ...
    $at(resT.rows[1+mm[0]], [['style','color:unset;']]);
    $at(resT.rows[1+mm[1]], [['style','color:unset;']]);
  }
  ...
  function cropFind () {
    ...
    function printFinal () {
      ...
      if (neFL) {
        var tHead = $ee('THEAD',$em('TR',[$c(''),$c(''),$c(''),$c(trImg('iExperience'),[['class','body']]),$c($em('div',[$e('i',[['class','resources_small']])]),[['style','width:52px']]),$c($em('div',[$e('i',[['class','resources_small']]),"/",trImg('def1')]),[['style','width:52px']]),$c(''),$c(''),$c('↔')]));
      } else {
      ...
      for( var i=0; i<aCCs.length; i++ ) {
        if( neFL ) {
                  var distance = calcDistance(xy2id(aCCs[i][1],aCCs[i][2]), cell_id)
            ...
            if( animX.snapshotLength > 0 ) {
              ...
              var ratio = ((res/td)).toFixed(2);
                          ...
                          switch (true) {
                              case res>20000:
                                  break;
                              case res>10000 && Number(ratio)>= 2:
                                  backgroundColor = 'lightGreen'
                                  break
                              case res>6000 && Number(ratio)>= 1.75:
                                  backgroundColor = 'yellow'
                                  break
                              default:
                          }
  
                          tBody.rows[i].style=`background-color:${backgroundColor}`;
                          var cellStyle = `font-weight:bold;background-color:${backgroundColor};`
              tBody.rows[i].cells[3].appendChild($em('div',[$em('div',[heroxp],[['class','body']])],[['id','reportWrapper'],['style',cellStyle]]));
              tBody.rows[i].cells[4].appendChild($em('div',[$em('div',[res],[['class','body']])],[['id','reportWrapper'],['style',cellStyle]]));
                          tBody.rows[i].cells[5].appendChild($em('div',[$em('div',[ratio],[['class','body']])],[['id','reportWrapper'],['style',cellStyle]]));
  ...
  function villageBMover () {
    ...
    var act = $ee('DIV',$e('IMG',[['src',img_bmove],['title',gtext("bmove")]]),
      [['style','position:absolute;top:140px;left:'+(ltr?820:380)+'px;z-index:500;width:32px;height:32px;cursor:pointer;']]);
