...
curl 'https://ttq.x2.america.travian.com/api/v1/farm-list/slot' \
  ...
  -H 'x-version: 200.13' \
  --data-raw '{"slots":[{"listId":5740,"x":'$x',"y":'$y',"units":{"t1":0,"t2":0,"t3":0,"t4":2,"t5":1,"t6":1,"t7":0,"t8":0,"t9":0,"t10":0},"active":true}]}'
