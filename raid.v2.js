...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 2, active: true, attackTroops: 1, distance: 14.8, id: 46813, interval: 5, name: 'Crushing`s village' },
			{ _no: 3, active: true, attackTroops: 1, distance: 21, id: 64980, interval: 5, name: 'Kathy`s village' },
			{ _no: 4, active: true, attackTroops: 1, distance: 24.5, id: 46816, interval: 5, name: 'Puclik`s village' },
			{ _no: 5, active: true, attackTroops: 1, distance: 26, id: 46817, interval: 5, name: '00' },
			{ _no: 6, active: true, attackTroops: 1, distance: 33.2, id: 46818, interval: 5, name: 'iygY6wBV7`s village' },
			{ _no: 7, active: true, attackTroops: 1, distance: 35.4, id: 46819, interval: 5, name: 'x1' },
			{ _no: 8, active: true, attackTroops: 1, distance: 38.1, id: 46820, interval: 5, name: 'Searching alliance' },
			{ _no: 9, active: true, attackTroops: 1, distance: 43.7, id: 46822, interval: 5, name: 'DKMMWQqxPk`s village' },
			{ _no: 10, active: true, attackTroops: 1, distance: 47.9, id: 46824, interval: 5, name: 'Pablo666`s village' },
