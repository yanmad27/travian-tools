...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 3, active: true, attackTroops: 1, distance: 24.5, id: 46816, interval: 5, name: 'Puclik`s village' },
			{ _no: 4, active: true, attackTroops: 1, distance: 26, id: 46817, interval: 5, name: '00' },
			{ _no: 5, active: true, attackTroops: 1, distance: 33.2, id: 46818, interval: 5, name: 'iygY6wBV7`s village' },
			{ _no: 6, active: true, attackTroops: 1, distance: 35.4, id: 46819, interval: 5, name: 'x1' },
