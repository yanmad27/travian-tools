...
const farmLists = [
	{
		...
		active: true,
		victims: [
			{ no: 1, id: 95559, active: true, name: '01' },
			{ no: 2, id: 62443, interval: 10, active: true, name: 'Mr.Piet 01' },
			{ no: 3, id: 62444, interval: 10, active: true, name: 'Mr.Piet 00' },
			{ no: 4, id: 77006, interval: 10, active: true, name: 'vuthanh16`s village' },
			{ no: 5, id: 96619, interval: 10, active: true, name: 'Oasis (‭−‭42‬‬|‭−‭5‬‬)' },
			{ no: 6, id: 93755, interval: 10, active: true, name: 'Oasis (‭−‭51‬‬|‭7‬)' },
			{ no: 7, id: 96620, interval: 10, active: true, name: 'Oasis (‭−‭43‬‬|‭−‭3‬‬)' },
			{ no: 8, id: 48393, interval: 10, active: true, name: 'Lyly 01' },
			{ no: 9, id: 80219, interval: 10, active: true, name: 'ngentod' },
			{ no: 10, id: 77012, interval: 10, active: true, name: '00' },
			{ no: 11, id: 70233, interval: 10, active: true, name: 'harry83820`s village' },
			{ no: 12, id: 87903, interval: 10, active: true, name: 'Ruacon`s village' },
			{ no: 13, id: 97871, interval: 10, active: true, name: '02' },
			{ no: 14, id: 77024, interval: 10, active: true, name: '01. Em ne' },
			{ no: 15, id: 77912, interval: 10, active: true, name: '1' },
			{ no: 16, id: 77023, interval: 10, active: true, name: 'İNEK' },
			{ no: 17, id: 87892, interval: 10, active: true, name: 'Eragon' },
			{ no: 18, id: 77016, interval: 10, active: true, name: 'Làng của SkyOne' },
			{ no: 19, id: 69810, interval: 10, active: true, name: '.' },
			{ no: 20, id: 87899, interval: 10, active: true, name: 'Centras' },
			{ no: 21, id: 78862, interval: 10, active: true, name: 'TEA' },
			{ no: 22, id: 69807, interval: 10, active: true, name: 'A' },
			{ no: 23, id: 92376, interval: 10, active: true, name: '01 - Galadriel' },
			{ no: 24, id: 80226, interval: 10, active: true, name: '32' },
		],
	},
	{
		id: 2291,
		active: true,
		victims: [
			{ no: 1, id: 87914, interval: 10, active: true, name: 'Deli`s village' },
			{ no: 2, id: 91945, interval: 10, active: true, name: 'EazyJJ的村莊' },
			{ no: 3, id: 87915, interval: 10, active: true, name: 'Azamat`s village' },
			{ no: 4, id: 87916, interval: 10, active: true, name: 'Lalala`s F' },
			{ no: 5, id: 87918, interval: 10, active: true, name: 'An Nghĩa Đường' },
			{ no: 6, id: 87917, interval: 10, active: true, name: 'หมู่บ้านของBAKI' },
			{ no: 7, id: 80221, interval: 10, active: true, name: '123' },
			{ no: 8, id: 99371, interval: 10, active: true, name: 'KOR1 | Kennametal' },
			{ no: 9, id: 99372, interval: 10, active: true, name: 'shoes19944116的村莊' },
			{ no: 10, id: 92374, interval: 10, active: true, name: 'Làng của abcd' },
			{ no: 11, id: 89961, interval: 10, active: true, name: 'Suri`s village' },
			{ no: 12, id: 99373, interval: 10, active: true, name: 'Athena`s village' },
			{ no: 13, id: 99374, interval: 10, active: true, name: 'New village' },
			{ no: 14, id: 99376, interval: 10, active: true, name: 'Dorf von Djimmy98' },
			{ no: 15, id: 99375, interval: 10, active: true, name: 'ab1` F' },
			{ no: 16, id: 99370, interval: 10, active: true, name: 'Badwolf`s village' },
			{ no: 17, id: 96621, interval: 10, active: true, name: 'Oasis (‭−‭51‬‬|‭6‬)' },
			{ no: 18, id: 93033, interval: 10, active: true, name: 'Oasis (‭−‭35‬‬|‭−‭6‬‬)' },
			{ no: 19, id: 101541, interval: 10, active: true, name: 'Buffalo' },
			{ no: 20, id: 97081, interval: 10, active: true, name: 'Oasis (‭−‭59‬‬|‭−‭80‬‬)' },
			{ no: 21, id: 92367, interval: 10, active: true, name: 'Стол' },
			{ no: 22, id: 90253, interval: 10, active: true, name: '3алупа' },
			{ no: 23, id: 91725, interval: 10, active: true, name: 'Lim Han Byul' },
			{ no: 24, id: 93022, interval: 10, active: true, name: 'Shin Yong Jae' },
		],
	},
]
