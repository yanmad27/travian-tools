...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 2, active: true, attackTroops: 5, id: 62443, interval: 5, name: 'Mr.Piet 01' },
			{ _no: 3, active: true, attackTroops: 1, id: 62444, interval: 5, name: 'Mr.Piet 00' },
			{ _no: 4, active: true, attackTroops: 4, id: 77006, interval: 5, name: 'vuthanh16`s village' },
			{ _no: 5, active: true, attackTroops: 7, id: 104724, interval: 5, name: 'HaMBa003' },
			{ _no: 6, active: true, attackTroops: 7, id: 93755, interval: 5, name: 'Oasis (−51|7)' },
			{ _no: 7, active: true, attackTroops: 4, id: 48393, interval: 5, name: 'Lyly 01' },
			{ _no: 8, active: true, attackTroops: 5, id: 80219, interval: 5, name: 'ngentod' },
			...
			{ _no: 12, active: true, attackTroops: 3, id: 87903, interval: 5, name: 'Ruacon`s village' },
			...
			{ _no: 15, active: true, attackTroops: 2, id: 77912, interval: 5, name: '1' },
			{ _no: 16, active: true, attackTroops: 2, id: 77023, interval: 5, name: 'İNEK' },
			{ _no: 17, active: true, attackTroops: 4, id: 87892, interval: 5, name: 'Eragon' },
			{ _no: 18, active: true, attackTroops: 3, id: 77016, interval: 5, name: 'Làng của SkyOne' },
			{ _no: 19, active: true, attackTroops: 5, id: 69810, interval: 5, name: '.' },
			{ _no: 20, active: true, attackTroops: 3, id: 87899, interval: 5, name: 'Centras' },
			{ _no: 21, active: true, attackTroops: 5, id: 78862, interval: 5, name: 'TEA' },
			{ _no: 22, active: true, attackTroops: 7, id: 69807, interval: 5, name: 'A' },
			{ _no: 23, active: true, attackTroops: 4, id: 80226, interval: 5, name: '32' },
			{ _no: 24, active: true, attackTroops: 12, id: 103136, interval: 5, name: 'Oasis (−43|64)' },
			{ _no: 25, active: true, attackTroops: 9, id: 104341, interval: 5, name: 'Oasis (−5|37)' },
			{ _no: 26, active: true, attackTroops: 2, id: 106486, interval: 5, name: 'А2' },
			{ _no: 27, active: true, attackTroops: 1, id: 106497, interval: 5, name: 'ineffanle' },
		],
	},
	{
		_no: 2,
		...
		victims: [
			...
			{ _no: 7, active: true, attackTroops: 6, id: 87918, interval: 5, name: 'An Nghĩa Đường' },
			...
			{ _no: 21, active: true, attackTroops: 5, id: 99375, interval: 5, name: 'ab1` F' },
			...
			{ _no: 28, active: true, attackTroops: 5, id: 103410, interval: 5, name: 'jasebaketravi`s village' },
			{ _no: 29, active: true, attackTroops: 10, id: 97081, interval: 5, name: 'Oasis (−59|−80)' },
			{ _no: 30, active: true, attackTroops: 8, id: 103134, interval: 5, name: 'Oasis (−38|−68)' },
			{ _no: 31, active: false, attackTroops: 100, id: 106494, interval: 5, name: 'Oasis (−21|−47)' },
			...
			{ _no: 37, active: false, attackTroops: 100, id: 106496, interval: 5, name: 'Kavo`s village' },
		],
	},
	{
		_no: 3,
