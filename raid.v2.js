...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 14, active: true, attackTroops: 5, id: 116807, interval: 5, name: '1.' },
			{ _no: 15, active: true, attackTroops: 2, id: 77024, interval: 5, name: '01. Em ne' },
			{ _no: 16, active: false, attackTroops: 50, id: 110888, interval: 30, name: '01. Kopi Susu' },
			{ _no: 17, active: true, attackTroops: 5, id: 110504, interval: 5, name: 'Oasis (−21|−47)' },
			{ _no: 18, active: true, attackTroops: 2, id: 77912, interval: 5, name: '1' },
			{ _no: 19, active: true, attackTroops: 5, id: 111200, interval: 5, name: 'Oasis (−22|−51)' },
			{ _no: 20, active: true, attackTroops: 1, id: 116832, interval: 5, name: '3. С' },
			{ _no: 21, active: true, attackTroops: 2, id: 77023, interval: 5, name: 'İNEK' },
			{ _no: 22, active: true, attackTroops: 4, id: 87892, interval: 5, name: 'Eragon' },
			{ _no: 23, active: true, attackTroops: 3, id: 77016, interval: 5, name: 'Làng của SkyOne' },
			{ _no: 24, active: true, attackTroops: 5, id: 69810, interval: 5, name: '.' },
			{ _no: 25, active: true, attackTroops: 5, id: 78862, interval: 5, name: 'TEA' },
			{ _no: 26, active: true, attackTroops: 1, id: 110513, interval: 5, name: '01' },
			{ _no: 27, active: true, attackTroops: 1, id: 110512, interval: 5, name: 'Làng của Giang' },
			{ _no: 28, active: true, attackTroops: 7, id: 110514, interval: 5, name: 'Chonxanhle' },
			{ _no: 29, active: true, attackTroops: 7, id: 69807, interval: 5, name: 'A' },
			{ _no: 30, active: true, attackTroops: 1, id: 116844, interval: 5, name: '02' },
			{ _no: 31, active: true, attackTroops: 3, id: 106630, interval: 5, name: 'Ardea' },
			{ _no: 32, active: true, attackTroops: 5, id: 80226, interval: 5, name: '32' },
			{ _no: 33, active: true, attackTroops: 3, id: 116846, interval: 5, name: 'Конь' },
			{ _no: 34, active: true, attackTroops: 6, id: 103136, interval: 5, name: 'Oasis (−43|64)' },
		],
	},
	{
		_no: 2,
		...
		victims: [
			...
			{ _no: 36, active: true, attackTroops: 5, id: 116839, interval: 5, name: 'Trai`s village' },
			{ _no: 37, active: true, attackTroops: 7, id: 93022, interval: 5, name: 'Shin Yong Jae' },
			{ _no: 38, active: true, attackTroops: 5, id: 116842, interval: 5, name: 'zMaCaRongz' },
			{ _no: 39, active: false, attackTroops: 50, id: 110518, interval: 30, name: '02. Kopi Hitam Pahit' },
			{ _no: 40, active: true, attackTroops: 3, id: 116845, interval: 5, name: 'tornado1975`s village' },
			{ _no: 41, active: true, attackTroops: 3, id: 110519, interval: 5, name: 'kancha`s village' },
			{ _no: 42, active: true, attackTroops: 5, id: 110520, interval: 5, name: 'MONKEY D LUFFY' },
			{ _no: 43, active: true, attackTroops: 1, id: 110521, interval: 5, name: 'muami`s village' },
			{ _no: 44, active: true, attackTroops: 5, id: 116847, interval: 5, name: 'Sanchal`s village' },
			{ _no: 45, active: true, attackTroops: 1, id: 116848, interval: 5, name: 'pong' },
			{ _no: 46, active: true, attackTroops: 1, id: 116849, interval: 5, name: 'zein`s village' },
		],
	},
	{
		_no: 3,
		...
		victims: [
			...
			{ _no: 15, active: true, attackTroops: 1, id: 116852, interval: 5, name: 'Zig`s village' },
			{ _no: 16, active: true, attackTroops: 1, id: 116853, interval: 5, name: 'AhmetCanS Köyü' },
			{ _no: 17, active: true, attackTroops: 1, id: 116854, interval: 5, name: 'مزرعة`s village' },
			{ _no: 18, active: true, attackTroops: 1, id: 116855, interval: 5, name: '别打我' },
			{ _no: 19, active: true, attackTroops: 1, id: 116856, interval: 5, name: 'Ulpia Traiana Sarmis' },
			{ _no: 20, active: true, attackTroops: 1, id: 116857, interval: 5, name: 'Karabela53 Köyü' },
			{ _no: 21, active: true, attackTroops: 1, id: 116858, interval: 5, name: 'Aldea de asdrano' },
			{ _no: 22, active: true, attackTroops: 2, id: 116859, interval: 5, name: '1' },
			{ _no: 23, active: true, attackTroops: 1, id: 116860, interval: 5, name: 'Indera Kayangan' },
			{ _no: 24, active: true, attackTroops: 2, id: 108295, interval: 5, name: 'piyade' },
			{ _no: 25, active: true, attackTroops: 2, id: 116861, interval: 5, name: '01' },
		],
	},
]
