...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 27, active: true, attackTroops: 2, id: 106486, interval: 5, name: 'А2' },
			{ _no: 28, active: true, attackTroops: 1, id: 106497, interval: 5, name: 'ineffanle' },
		],
	},
	{
		_no: 2,
		...
		victims: [
			...
			{ _no: 29, active: true, attackTroops: 45, id: 108685, interval: 5, name: 'Bò' },
			{ _no: 30, active: true, attackTroops: 45, id: 108700, interval: 5, name: 'Gà' },
			{ _no: 31, active: true, attackTroops: 15, id: 108701, interval: 5, name: 'Mõm' },
			{ _no: 32, active: true, attackTroops: 5, id: 97081, interval: 5, name: 'Oasis (−59|−80)' },
			{ _no: 33, active: true, attackTroops: 6, id: 107547, interval: 5, name: '2.B' },
			{ _no: 34, active: true, attackTroops: 6, id: 103134, interval: 5, name: 'Oasis (−38|−68)' },
			{ _no: 35, active: true, attackTroops: 2, id: 106495, interval: 5, name: 'Oasis (−76|44)' },
			{ _no: 36, active: true, attackTroops: 2, id: 105961, interval: 5, name: 'taukiss Köyü' },
			{ _no: 37, active: true, attackTroops: 2, id: 91725, interval: 5, name: 'Lim Han Byul' },
			{ _no: 38, active: true, attackTroops: 7, id: 93022, interval: 5, name: 'Shin Yong Jae' },
			{ _no: 39, active: true, attackTroops: 20, id: 108295, interval: 5, name: 'piyade' },
		],
	},
	{
		_no: 3,
...
bot.activateVictim(108700, 30)
bot.activateVictim(108701, 30)
