...
const farmLists = [
	{
		...
		id: 1817,
		victims: [
			{ _no: 1, active: true, id: 104725, interval: 5, name: '01. ThienTuCutHeo' },
			{ _no: 2, active: true, id: 62443, interval: 5, name: 'Mr.Piet 01' },
			{ _no: 3, active: true, id: 62444, interval: 5, name: 'Mr.Piet 00' },
			{ _no: 4, active: true, id: 77006, interval: 5, name: 'vuthanh16`s village' },
			{ _no: 5, active: true, id: 104724, interval: 5, name: 'HaMBa003' },
			{ _no: 6, active: true, id: 93755, interval: 5, name: 'Oasis (−51|7)' },
			{ _no: 7, active: true, id: 48393, interval: 5, name: 'Lyly 01' },
			{ _no: 8, active: true, id: 80219, interval: 5, name: 'ngentod' },
			{ _no: 9, active: true, id: 103293, interval: 5, name: 'HaMBa001' },
			{ _no: 10, active: true, id: 77012, interval: 5, name: '00' },
			{ _no: 11, active: true, id: 70233, interval: 5, name: 'harry83820`s village' },
			{ _no: 12, active: true, id: 87903, interval: 5, name: 'Ruacon`s village' },
			{ _no: 13, active: true, id: 103133, interval: 5, name: 'Oasis (−39|−67)' },
			{ _no: 14, active: true, id: 77024, interval: 5, name: '01. Em ne' },
			{ _no: 15, active: true, id: 77912, interval: 5, name: '1' },
			{ _no: 16, active: true, id: 77023, interval: 5, name: 'İNEK' },
			{ _no: 17, active: true, id: 87892, interval: 5, name: 'Eragon' },
			{ _no: 18, active: true, id: 77016, interval: 5, name: 'Làng của SkyOne' },
			{ _no: 19, active: true, id: 69810, interval: 5, name: '.' },
			{ _no: 20, active: true, id: 87899, interval: 5, name: 'Centras' },
			{ _no: 21, active: true, id: 78862, interval: 5, name: 'TEA' },
			{ _no: 22, active: true, id: 69807, interval: 5, name: 'A' },
			{ _no: 23, active: true, id: 80226, interval: 5, name: '32' },
			{ _no: 24, active: true, id: 103136, interval: 5, name: 'Oasis (−43|64)' },
			{ _no: 25, active: true, id: 104341, interval: 5, name: 'Oasis (−5|37)' },
		],
	},
	{
		_no: 2,
		...
		id: 2291,
		victims: [
			{ _no: 1, active: true, id: 87914, interval: 5, name: 'Deli`s village' },
			{ _no: 2, active: true, id: 91945, interval: 5, name: 'EazyJJ的村莊' },
			{ _no: 3, active: true, id: 87915, interval: 5, name: 'Azamat`s village' },
			{ _no: 4, active: true, id: 103452, interval: 5, name: 'Natars -68|-20' },
			{ _no: 5, active: true, id: 102592, interval: 5, name: 'Let的村莊' },
			{ _no: 6, active: true, id: 87916, interval: 5, name: 'Lalala`s F' },
			{ _no: 7, active: true, id: 87918, interval: 5, name: 'An Nghĩa Đường' },
			{ _no: 8, active: true, id: 87917, interval: 5, name: 'หมู่บ้านของBAKI' },
			{ _no: 9, active: true, id: 80221, interval: 5, name: '123' },
			{ _no: 10, active: true, id: 99371, interval: 5, name: 'KOR1 | Kennametal' },
			{ _no: 11, active: true, id: 99372, interval: 5, name: 'shoes19944116的村莊' },
			{ _no: 12, active: true, id: 92374, interval: 5, name: 'Làng của abcd' },
			{ _no: 13, active: true, id: 103425, interval: 5, name: 'Natars -52|-22' },
			{ _no: 14, active: true, id: 89961, interval: 5, name: 'Suri`s village' },
			{ _no: 15, active: true, id: 105962, interval: 5, name: '風のAPiau的村莊' },
			{ _no: 16, active: true, id: 99373, interval: 5, name: 'Athena`s village' },
			{ _no: 17, active: true, id: 101908, interval: 5, name: 'Natars -84|-59' },
			{ _no: 18, active: true, id: 99374, interval: 5, name: 'New village' },
			{ _no: 19, active: true, id: 99376, interval: 5, name: 'Dorf von Djimmy98' },
			{ _no: 20, active: true, id: 99375, interval: 5, name: 'ab1` F' },
			{ _no: 21, active: true, id: 99370, interval: 5, name: 'Badwolf`s village' },
			{ _no: 22, active: true, id: 96621, interval: 5, name: 'Oasis (−51|6)' },
			{ _no: 23, active: true, id: 105960, interval: 5, name: 'Moon`s village' },
			{ _no: 24, active: true, id: 104059, interval: 5, name: 'Natars -41|7' },
			{ _no: 25, active: true, id: 105959, interval: 5, name: 'Làng của Gái già' },
			{ _no: 26, active: true, id: 101541, interval: 5, name: 'Buffalo' },
			{ _no: 27, active: true, id: 103410, interval: 5, name: 'jasebaketravi`s village' },
			{ _no: 28, active: true, id: 97081, interval: 5, name: 'Oasis (−59|−80)' },
			{ _no: 29, active: true, id: 103134, interval: 5, name: 'Oasis (−38|−68)' },
			{ _no: 30, active: true, id: 104342, interval: 5, name: 'Oasis (−56|37)' },
			{ _no: 31, active: true, id: 105961, interval: 5, name: 'taukiss Köyü' },
			{ _no: 32, active: true, id: 91725, interval: 5, name: 'Lim Han Byul' },
			{ _no: 33, active: true, id: 93022, interval: 5, name: 'Shin Yong Jae' },
		],
	},
	{
		_no: 3,
		...
		id: 2573,
		victims: [
			{ _no: 1, active: true, id: 104744, interval: 5, name: 'prof 2' },
			{ _no: 2, active: true, id: 104745, interval: 5, name: 'prof 3' },
		],
	},
]
