...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 12, active: true, id: 77024, interval: 10, name: '01. Em ne' },
			{ _no: 13, active: true, id: 77912, interval: 10, name: '1' },
			{ _no: 14, active: true, id: 77023, interval: 10, name: 'İNEK' },
			{ _no: 15, active: true, id: 87892, interval: 10, name: 'Eragon' },
			{ _no: 16, active: true, id: 77016, interval: 10, name: 'Làng của SkyOne' },
			{ _no: 17, active: true, id: 69810, interval: 10, name: '.' },
			{ _no: 18, active: true, id: 87899, interval: 10, name: 'Centras' },
			{ _no: 19, active: true, id: 78862, interval: 10, name: 'TEA' },
			{ _no: 20, active: true, id: 69807, interval: 10, name: 'A' },
			{ _no: 21, active: true, id: 92376, interval: 10, name: '01 - Galadriel' },
			{ _no: 22, active: true, id: 80226, interval: 10, name: '32' },
		],
	},
	{
		_no: 2,
		...
		victims: [
			...
			{ _no: 24, active: true, id: 90253, interval: 10, name: '3алупа' },
			{ _no: 25, active: true, id: 91725, interval: 10, name: 'Lim Han Byul' },
			{ _no: 26, active: true, id: 93022, interval: 10, name: 'Shin Yong Jae' },
		],
	},
