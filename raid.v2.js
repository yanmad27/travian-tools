...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 5, active: true, attackTroops: 8, id: 104724, interval: 5, name: 'HaMBa003' },
			{ _no: 6, active: true, attackTroops: 5, id: 93755, interval: 5, name: 'Oasis (−51|7)' },
			{ _no: 7, active: true, attackTroops: 6, id: 107757, interval: 5, name: 'HaMBa002_15C' },
			{ _no: 8, active: true, attackTroops: 4, id: 48393, interval: 5, name: 'Lyly 01' },
			{ _no: 9, active: true, attackTroops: 8, id: 103293, interval: 5, name: 'HaMBa001' },
			{ _no: 10, active: true, attackTroops: 1, id: 77012, interval: 5, name: '00' },
			{ _no: 11, active: true, attackTroops: 3, id: 70233, interval: 5, name: 'harry83820`s village' },
			{ _no: 12, active: true, attackTroops: 2, id: 87903, interval: 5, name: 'Ruacon`s village' },
			{ _no: 13, active: true, attackTroops: 3, id: 108067, interval: 5, name: 'Làng mới' },
			...
			{ _no: 16, active: false, attackTroops: 50, id: 110503, interval: 5, name: 'Phương Khanh' },
			...
			{ _no: 25, active: false, attackTroops: 50, id: 110512, interval: 5, name: 'Làng của Giang' },
			{ _no: 26, active: false, attackTroops: 50, id: 110514, interval: 5, name: 'Chonxanhle' },
			...
			{ _no: 30, active: true, attackTroops: 15, id: 103136, interval: 5, name: 'Oasis (−43|64)' },
			{ _no: 31, active: true, attackTroops: 1, id: 106497, interval: 5, name: 'ineffanle' },
		],
	},
	{
		_no: 2,
		...
		victims: [
			...
			{ _no: 13, active: true, attackTroops: 8, id: 92374, interval: 5, name: 'Làng của abcd' },
			{ _no: 14, active: true, attackTroops: 5, id: 103425, interval: 5, name: 'Natars -52|-22' },
			...
			{ _no: 21, active: true, attackTroops: 7, id: 99375, interval: 5, name: 'ab1` F' },
			...
			{ _no: 28, active: false, attackTroops: 45, id: 108685, interval: 5, name: 'Bò' },
			{ _no: 29, active: false, attackTroops: 45, id: 108700, interval: 5, name: 'Gà' },
			{ _no: 30, active: true, attackTroops: 5, id: 108701, interval: 5, name: 'Mõm' },
			{ _no: 31, active: true, attackTroops: 5, id: 97081, interval: 5, name: 'Oasis (−59|−80)' },
			{ _no: 32, active: true, attackTroops: 6, id: 107547, interval: 5, name: '2.B' },
			{ _no: 33, active: true, attackTroops: 6, id: 103134, interval: 5, name: 'Oasis (−38|−68)' },
			{ _no: 34, active: true, attackTroops: 2, id: 106495, interval: 5, name: 'Oasis (−76|44)' },
			{ _no: 35, active: false, attackTroops: 50, id: 110505, interval: 5, name: 'aisenyir' },
			{ _no: 36, active: false, attackTroops: 50, id: 110510, interval: 5, name: 'C.C.的村莊' },
			{ _no: 37, active: false, attackTroops: 50, id: 110511, interval: 5, name: '1' },
			{ _no: 38, active: true, attackTroops: 2, id: 91725, interval: 5, name: 'Lim Han Byul' },
			{ _no: 39, active: true, attackTroops: 7, id: 93022, interval: 5, name: 'Shin Yong Jae' },
			{ _no: 40, active: false, attackTroops: 50, id: 110518, interval: 5, name: '02. Kopi Hitam Pahit' },
			{ _no: 41, active: false, attackTroops: 50, id: 110519, interval: 5, name: 'kancha`s village' },
			{ _no: 42, active: false, attackTroops: 50, id: 110520, interval: 5, name: 'MONKEY D LUFFY' },
			{ _no: 43, active: false, attackTroops: 50, id: 110521, interval: 5, name: 'muami`s village' },
			{ _no: 44, active: true, attackTroops: 5, id: 108295, interval: 5, name: 'piyade' },
		],
	},
	{
		_no: 3,
		...
		victims: [
			...
			{ _no: 6, active: false, attackTroops: 100, id: 104745, interval: 5, name: 'prof 3' },
			{ _no: 7, active: true, attackTroops: 1, id: 106486, interval: 5, name: 'А2' },
			{ _no: 8, active: true, attackTroops: 2, id: 110491, interval: 5, name: 'M52 87 4988 1 93' },
			{ _no: 9, active: true, attackTroops: 1, id: 110492, interval: 5, name: 'hachiprint' },
			{ _no: 10, active: true, attackTroops: 2, id: 110493, interval: 5, name: 'jjiongche`s village' },
		],
	},
]
