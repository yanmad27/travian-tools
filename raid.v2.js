...
const farmLists = [
	{
		...
		id: 1817,
		victims: [
			{ _no: 1, active: true, attackTroops: 7, id: 110490, interval: 5, name: '新村莊' },
			{ _no: 2, active: true, attackTroops: 6, id: 104725, interval: 5, name: '01. ThienTuCutHeo' },
			...
			{ _no: 8, active: true, attackTroops: 6, id: 107757, interval: 5, name: 'HaMBa002_15C' },
			...
			{ _no: 14, active: true, attackTroops: 3, id: 108067, interval: 5, name: 'Làng mới' },
			{ _no: 15, active: true, attackTroops: 7, id: 103133, interval: 5, name: 'Oasis (−39|−67)' },
			{ _no: 16, active: true, attackTroops: 2, id: 77024, interval: 5, name: '01. Em ne' },
			{ _no: 17, active: false, attackTroops: 50, id: 110503, interval: 5, name: 'Phương Khanh' },
			{ _no: 18, active: true, attackTroops: 5, id: 110504, interval: 5, name: 'Oasis (−21|−47)' },
			{ _no: 19, active: true, attackTroops: 2, id: 77912, interval: 5, name: '1' },
			{ _no: 20, active: true, attackTroops: 2, id: 77023, interval: 5, name: 'İNEK' },
			{ _no: 21, active: true, attackTroops: 4, id: 87892, interval: 5, name: 'Eragon' },
			{ _no: 22, active: true, attackTroops: 3, id: 77016, interval: 5, name: 'Làng của SkyOne' },
			{ _no: 23, active: true, attackTroops: 5, id: 69810, interval: 5, name: '.' },
			{ _no: 24, active: true, attackTroops: 5, id: 78862, interval: 5, name: 'TEA' },
			{ _no: 25, active: true, attackTroops: 7, id: 69807, interval: 5, name: 'A' },
			{ _no: 26, active: true, attackTroops: 3, id: 106630, interval: 5, name: 'Ardea' },
			{ _no: 27, active: true, attackTroops: 5, id: 80226, interval: 5, name: '32' },
			{ _no: 28, active: true, attackTroops: 15, id: 103136, interval: 5, name: 'Oasis (−43|64)' },
	...
	},
	{
		...
		victims: [
			...
			{ _no: 36, active: true, attackTroops: 2, id: 91725, interval: 5, name: 'Lim Han Byul' },
			{ _no: 37, active: true, attackTroops: 7, id: 93022, interval: 5, name: 'Shin Yong Jae' },
			{ _no: 38, active: true, attackTroops: 5, id: 108295, interval: 5, name: 'piyade' },
		],
	},
	{
		_no: 3,
