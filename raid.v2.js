...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 14, active: false, attackTroops: 100, id: 107547, interval: 5, name: '2.B' },
			...
			{ _no: 23, active: true, attackTroops: 3, id: 106630, interval: 5, name: 'Ardea' },
			{ _no: 24, active: true, attackTroops: 4, id: 80226, interval: 5, name: '32' },
			{ _no: 25, active: true, attackTroops: 15, id: 103136, interval: 5, name: 'Oasis (−43|64)' },
			{ _no: 26, active: true, attackTroops: 15, id: 104341, interval: 5, name: 'Oasis (−5|37)' },
			{ _no: 27, active: true, attackTroops: 2, id: 106486, interval: 5, name: 'А2' },
			{ _no: 28, active: true, attackTroops: 3, id: 106497, interval: 5, name: 'ineffanle' },
		],
	},
	{
		_no: 2,
	...
	},
	{
		...
		id: 2573,
		victims: [
			{ _no: 1, active: true, attackTroops: 2, id: 107732, interval: 5, name: 'jebray`s village' },
