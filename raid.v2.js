...
const farmLists = [
	{
		...
		victims: [
			...
			{ _no: 8, active: true, attackTroops: 8, id: 103293, interval: 5, name: 'HaMBa001' },
			{ _no: 9, active: true, attackTroops: 1, id: 77012, interval: 5, name: '00' },
			{ _no: 10, active: true, attackTroops: 3, id: 70233, interval: 5, name: 'harry83820`s village' },
			{ _no: 11, active: true, attackTroops: 50, id: 111665, interval: 30, name: '0.B' },
			...
			{ _no: 25, active: true, attackTroops: 1, id: 110513, interval: 5, name: '01' },
			{ _no: 26, active: true, attackTroops: 1, id: 110512, interval: 5, name: 'Làng của Giang' },
			{ _no: 27, active: true, attackTroops: 7, id: 110514, interval: 5, name: 'Chonxanhle' },
			{ _no: 28, active: true, attackTroops: 7, id: 69807, interval: 5, name: 'A' },
			...
			{ _no: 31, active: true, attackTroops: 6, id: 103136, interval: 5, name: 'Oasis (−43|64)' },
		],
	},
	{
		_no: 2,
		...
		victims: [
			...
			{ _no: 26, active: true, attackTroops: 50, id: 113527, interval: 30, name: '0.B' },
			...
			{ _no: 33, active: true, attackTroops: 10, id: 110505, interval: 5, name: 'aisenyir' },
			{ _no: 34, active: true, attackTroops: 6, id: 110511, interval: 5, name: '1' },
			...
			{ _no: 37, active: false, attackTroops: 50, id: 110518, interval: 30, name: '02. Kopi Hitam Pahit' },
			{ _no: 38, active: false, attackTroops: 3, id: 110519, interval: 5, name: 'kancha`s village' },
			{ _no: 39, active: true, attackTroops: 5, id: 110520, interval: 5, name: 'MONKEY D LUFFY' },
			{ _no: 40, active: true, attackTroops: 1, id: 110521, interval: 5, name: 'muami`s village' },
			{ _no: 41, active: true, attackTroops: 5, id: 108295, interval: 5, name: 'piyade' },
		],
	},
	{
		_no: 3,
