...
const farmLists = [
	...
	},
	{
		...
		victims: [
			...
			{ no: 13, id: 101908, interval: 10, active: true, name: '01' },
			{ no: 14, id: 99374, interval: 10, active: true, name: 'New village' },
			{ no: 15, id: 99376, interval: 10, active: true, name: 'Dorf von Djimmy98' },
			{ no: 16, id: 99375, interval: 10, active: true, name: 'ab1` F' },
			{ no: 17, id: 99370, interval: 10, active: true, name: 'Badwolf`s village' },
			{ no: 18, id: 96621, interval: 10, active: true, name: 'Oasis (‭−‭51‬‬|‭6‬)' },
			{ no: 19, id: 93033, interval: 10, active: true, name: 'Oasis (‭−‭35‬‬|‭−‭6‬‬)' },
			{ no: 20, id: 101541, interval: 10, active: true, name: 'Buffalo' },
			{ no: 21, id: 97081, interval: 10, active: true, name: 'Oasis (‭−‭59‬‬|‭−‭80‬‬)' },
			{ no: 22, id: 92367, interval: 10, active: true, name: 'Стол' },
			{ no: 23, id: 90253, interval: 10, active: true, name: '3алупа' },
			{ no: 24, id: 91725, interval: 10, active: true, name: 'Lim Han Byul' },
			{ no: 25, id: 93022, interval: 10, active: true, name: 'Shin Yong Jae' },
		],
	},
]
