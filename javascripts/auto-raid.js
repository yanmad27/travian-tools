const lsk_autoRaid = 'autoRaid'

function autoRaidImplementation() {
	...
	class FarmBot {
		...
		async activateVictim(id, interval) {
			try {
				await this.deactivateVictim(id)
...
document.addEventListener('DOMContentLoaded', () => {
	const autoRaidButton = document.getElementById('autoRaid')
	autoRaidButton.addEventListener('click', autoRaid)
})
